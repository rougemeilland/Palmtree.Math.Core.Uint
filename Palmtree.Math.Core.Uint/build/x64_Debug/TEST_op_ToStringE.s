...
.LC0:
	...
	.align 8
.LC1:
	.ascii "P\0M\0C\0_\0T\0o\0S\0t\0r\0i\0n\0g\0E\0 \0(\0%\0d\0.\0%\0d\0)\0\0\0"
	.align 8
.LC2:
...
.LC3:
	...
	.text
	.globl	TEST_PMC_ToStringE
	.def	TEST_PMC_ToStringE;	.scl	2;	.type	32;	.endef
	.seh_proc	TEST_PMC_ToStringE
TEST_PMC_ToStringE:
.LFB4274:
	.file 1 "../TEST_op_ToStringE.c"
	.loc 1 33 1
	.cfi_startproc
	pushq	%rbp
	.seh_pushreg	%rbp
...
.LVL2:
	...
	movq	64(%rbp), %rdx
	movq	$8192, 32(%rsp)
	leaq	actual_str_buffer.84490(%rip), %r9
	call	*%rax
.LVL3:
	movl	%eax, -8(%rbp)
	.loc 1 42 5
	...
	movq	80(%rbp), %rax
	movq	%rax, %rdx
	leaq	actual_str_buffer.84490(%rip), %rcx
...
.LFE4274:
	.seh_endproc
.lcomm actual_str_buffer.84490,8192,32
.Letext0:
