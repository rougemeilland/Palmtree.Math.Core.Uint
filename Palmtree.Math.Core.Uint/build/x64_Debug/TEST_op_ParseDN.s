...
.LVL5:
	...
	.loc 2 48 85
	movq	-16(%rbp), %rcx
	leaq	actual_buf_size.84462(%rip), %r9
	movl	$256, %r8d
	leaq	actual_buf.84461(%rip), %rdx
	call	*%rax
.LVL6:
	movl	%eax, -8(%rbp)
	.loc 2 48 9
	...
	call	TEST_Assert
	.loc 2 49 75
	movq	actual_buf_size.84462(%rip), %rax
	movq	120(%rbp), %rcx
	movq	112(%rbp), %rdx
	movq	%rcx, %r9
	movq	%rdx, %r8
	movq	%rax, %rdx
	leaq	actual_buf.84461(%rip), %rcx
	call	_EQUALS_MEMORY
	.loc 2 49 9
	testl	%eax, %eax
	sete	%al
...
.LVL9:
	...
	.loc 2 67 85
	movq	-16(%rbp), %rcx
	leaq	actual_buf_size.84478(%rip), %r9
	movl	$256, %r8d
	leaq	actual_buf.84477(%rip), %rdx
	call	*%rax
.LVL10:
	movl	%eax, -8(%rbp)
	.loc 2 67 9
	...
	call	TEST_Assert
	.loc 2 68 75
	movq	actual_buf_size.84478(%rip), %rax
	movq	88(%rbp), %rcx
	movq	80(%rbp), %rdx
	movq	%rcx, %r9
	movq	%rdx, %r8
	movq	%rax, %rdx
	leaq	actual_buf.84477(%rip), %rcx
	call	_EQUALS_MEMORY
	.loc 2 68 9
	testl	%eax, %eax
	sete	%al
...
.LVL13:
	...
	.loc 2 86 85
	movq	-16(%rbp), %rcx
	leaq	actual_buf_size.84494(%rip), %r9
	movl	$256, %r8d
	leaq	actual_buf.84493(%rip), %rdx
	call	*%rax
.LVL14:
	movl	%eax, -8(%rbp)
	.loc 2 86 9
	...
	call	TEST_Assert
	.loc 2 87 75
	movq	actual_buf_size.84494(%rip), %rax
	movq	88(%rbp), %rcx
	movq	80(%rbp), %rdx
	movq	%rcx, %r9
	movq	%rdx, %r8
	movq	%rax, %rdx
	leaq	actual_buf.84493(%rip), %rcx
	call	_EQUALS_MEMORY
	.loc 2 87 9
	testl	%eax, %eax
	sete	%al
...
.LFE4276:
	.seh_endproc
.lcomm actual_buf.84461,256,32
.lcomm actual_buf_size.84462,8,8
.lcomm actual_buf.84477,256,32
.lcomm actual_buf_size.84478,8,8
.lcomm actual_buf.84493,256,32
.lcomm actual_buf_size.84494,8,8
.Letext0:
