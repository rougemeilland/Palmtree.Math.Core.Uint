...
.LVL5:
	...
	.loc 2 48 85
	movq	-16(%rbp), %rcx
	leaq	actual_buf_size.84496(%rip), %r9
	movl	$256, %r8d
	leaq	actual_buf.84495(%rip), %rdx
	call	*%rax
.LVL6:
	movl	%eax, -8(%rbp)
	.loc 2 48 9
	...
	call	TEST_Assert
	.loc 2 49 75
	movq	actual_buf_size.84496(%rip), %rax
	movq	120(%rbp), %rcx
	movq	112(%rbp), %rdx
	movq	%rcx, %r9
	movq	%rdx, %r8
	movq	%rax, %rdx
	leaq	actual_buf.84495(%rip), %rcx
	call	_EQUALS_MEMORY
	.loc 2 49 9
	testl	%eax, %eax
	sete	%al
...
.LVL9:
	...
	.loc 2 67 85
	movq	-16(%rbp), %rcx
	leaq	actual_buf_size.84512(%rip), %r9
	movl	$256, %r8d
	leaq	actual_buf.84511(%rip), %rdx
	call	*%rax
.LVL10:
	movl	%eax, -8(%rbp)
	.loc 2 67 9
	...
	call	TEST_Assert
	.loc 2 68 75
	movq	actual_buf_size.84512(%rip), %rax
	movq	88(%rbp), %rcx
	movq	80(%rbp), %rdx
	movq	%rcx, %r9
	movq	%rdx, %r8
	movq	%rax, %rdx
	leaq	actual_buf.84511(%rip), %rcx
	call	_EQUALS_MEMORY
	.loc 2 68 9
	testl	%eax, %eax
	sete	%al
...
.LC5:
	...
	.text
	.globl	TEST_PMC_ParseDN3
	.def	TEST_PMC_ParseDN3;	.scl	2;	.type	32;	.endef
	.seh_proc	TEST_PMC_ParseDN3
TEST_PMC_ParseDN3:
.LFB4276:
	.loc 2 75 1
	.cfi_startproc
...
.LVL13:
	...
	.loc 2 86 85
	movq	-16(%rbp), %rcx
	leaq	actual_buf_size.84528(%rip), %r9
	movl	$256, %r8d
	leaq	actual_buf.84527(%rip), %rdx
	call	*%rax
.LVL14:
	movl	%eax, -8(%rbp)
	.loc 2 86 9
	...
	call	TEST_Assert
	.loc 2 87 75
	movq	actual_buf_size.84528(%rip), %rax
	movq	88(%rbp), %rcx
	movq	80(%rbp), %rdx
	movq	%rcx, %r9
	movq	%rdx, %r8
	movq	%rax, %rdx
	leaq	actual_buf.84527(%rip), %rcx
	call	_EQUALS_MEMORY
	.loc 2 87 9
	testl	%eax, %eax
	sete	%al
...
.LFE4276:
	.seh_endproc
.lcomm actual_buf.84495,256,32
.lcomm actual_buf_size.84496,8,8
.lcomm actual_buf.84511,256,32
.lcomm actual_buf_size.84512,8,8
.lcomm actual_buf.84527,256,32
.lcomm actual_buf_size.84528,8,8
.Letext0:
