...
.LC0:
	...
	.align 8
.LC1:
	.ascii "P\0M\0C\0_\0T\0o\0S\0t\0r\0i\0n\0g\0P\0 \0(\0%\0d\0.\0%\0d\0)\0\0\0"
	.align 8
.LC2:
...
.LC3:
	...
	.text
	.globl	TEST_PMC_ToStringP
	.def	TEST_PMC_ToStringP;	.scl	2;	.type	32;	.endef
	.seh_proc	TEST_PMC_ToStringP
TEST_PMC_ToStringP:
.LFB4274:
	.file 1 "../TEST_op_ToStringP.c"
	.loc 1 33 1
	.cfi_startproc
	pushq	%rbp
	.seh_pushreg	%rbp
...
.LVL5:
	...
	movq	64(%rbp), %rdx
	movq	$8192, 32(%rsp)
	leaq	actual_str_buffer.84495(%rip), %r9
	call	*%rax
.LVL6:
	movl	%eax, -8(%rbp)
	.loc 1 47 5
	...
	movq	120(%rbp), %rax
	movq	%rax, %rdx
	leaq	actual_str_buffer.84495(%rip), %rcx
...
.LFE4274:
	.seh_endproc
.lcomm actual_str_buffer.84495,8192,32
.Letext0:
	...
	.file 32 "C:/GNU/MINGW64/x86_64-8.1.0-win32-seh-rt_v6-rev0/mingw64/x86_64-w64-mingw32/include/winbase.h"
