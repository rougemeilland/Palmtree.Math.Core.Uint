...
.LVL1:
	...
	.loc 2 44 83
	movq	-16(%rbp), %rcx
	leaq	actual_buf_size.84492(%rip), %r9
	movl	$256, %r8d
	leaq	actual_buf.84491(%rip), %rdx
	call	*%rax
.LVL2:
	movl	%eax, -8(%rbp)
	.loc 2 44 9
	...
	call	TEST_Assert
	.loc 2 45 73
	movq	actual_buf_size.84492(%rip), %rax
	movq	88(%rbp), %rcx
	movq	80(%rbp), %rdx
	movq	%rcx, %r9
	movq	%rdx, %r8
	movq	%rax, %rdx
	leaq	actual_buf.84491(%rip), %rcx
	call	_EQUALS_MEMORY
	.loc 2 45 9
	testl	%eax, %eax
	sete	%al
...
.LFE4274:
	.seh_endproc
.lcomm actual_buf.84491,256,32
.lcomm actual_buf_size.84492,8,8
.Letext0:
