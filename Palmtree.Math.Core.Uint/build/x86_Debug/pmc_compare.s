...
LBB23:
	...
	jmp	L71
L70:
	.loc 4 309 29 discriminator 2
	movl	$-1, %eax
L71:
	.loc 4 309 15 is_stmt 1 discriminator 4
	movl	%eax, -28(%ebp)
	jmp	L72
L69:
LBB24:
...
LBE23:
	...
	testl	%eax, %eax
	je	L76
	.loc 4 333 25 discriminator 1
	movl	-28(%ebp), %eax
	.loc 4 333 20 discriminator 1
	cmpl	$1, %eax
	je	L76
	.loc 4 333 35 discriminator 2
	movl	-28(%ebp), %eax
	.loc 4 333 30 discriminator 2
	cmpl	$-1, %eax
	je	L76
	.loc 4 334 122
	movl	$16, (%esp)
