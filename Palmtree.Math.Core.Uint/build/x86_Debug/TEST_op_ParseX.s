...
LVL1:
	...
	.loc 2 44 83
	movl	-20(%ebp), %edx
	movl	$_actual_buf_size.61431, 12(%esp)
	movl	$256, 8(%esp)
	movl	$_actual_buf.61430, 4(%esp)
	movl	%edx, (%esp)
	call	*%eax
LVL2:
	subl	$16, %esp
	...
	call	_TEST_Assert
	.loc 2 45 73
	movl	_actual_buf_size.61431, %eax
	movl	36(%ebp), %edx
	movl	%edx, 12(%esp)
	movl	32(%ebp), %edx
	movl	%edx, 8(%esp)
	movl	%eax, 4(%esp)
	movl	$_actual_buf.61430, (%esp)
...
L10:
	...
	.cfi_endproc
LFE72:
.lcomm _actual_buf.61430,256,32
.lcomm _actual_buf_size.61431,4,4
Letext0:
