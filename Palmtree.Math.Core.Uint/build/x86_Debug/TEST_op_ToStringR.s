...
LC3:
	...
	.text
	.globl	_TEST_PMC_ToStringR
	.def	_TEST_PMC_ToStringR;	.scl	2;	.type	32;	.endef
_TEST_PMC_ToStringR:
LFB72:
...
LVL1:
	...
	movl	-20(%ebp), %edx
	movl	$8192, 16(%esp)
	movl	$_actual_str_buffer.61462, 12(%esp)
	leal	-196(%ebp), %ecx
	movl	%ecx, 8(%esp)
	movl	28(%ebp), %ecx
	movl	%ecx, 4(%esp)
...
LVL2:
	...
	movl	32(%ebp), %eax
	movl	%eax, 4(%esp)
	movl	$_actual_str_buffer.61462, (%esp)
...
L3:
	...
	.cfi_endproc
LFE72:
.lcomm _actual_str_buffer.61462,8192,32
Letext0:
