...
L5:
	...
	.cfi_endproc
LFE4234:
	.def	_Equals_X_I_Imp;	.scl	3;	.type	32;	.endef
_Equals_X_I_Imp:
LFB4244:
	.file 2 "../pmc_equals.c"
	.loc 2 32 1
...
LBE2:
	...
	.cfi_endproc
LFE4244:
	.def	_Equals_X_L_Imp;	.scl	3;	.type	32;	.endef
_Equals_X_L_Imp:
LFB4245:
	.loc 2 63 1
	.cfi_startproc
...
L18:
	...
	cmpl	%eax, %edx
	jne	L19
	.loc 2 112 53 discriminator 1
	movl	8(%ebp), %eax
	movl	36(%eax), %eax
	.loc 2 112 60 discriminator 1
	movl	(%eax), %eax
	.loc 2 112 49 discriminator 1
	cmpl	%eax, -8(%ebp)
	jne	L19
	.loc 2 112 49 is_stmt 0 discriminator 3
	movl	$1, %eax
	jmp	L13
L19:
	.loc 2 112 49 discriminator 4
	movl	$0, %eax
L13:
LBE5:
LBE3:
	.loc 2 136 1 is_stmt 1 discriminator 1
	leave
	.cfi_restore 5
	.cfi_def_cfa 4, 4
	ret
	.cfi_endproc
LFE4245:
	.def	_Equals_X_X_Imp;	.scl	3;	.type	32;	.endef
_Equals_X_X_Imp:
LFB4246:
	.loc 2 139 1
	.cfi_startproc
...
L42:
	...
	testl	%eax, %eax
	je	L43
	.loc 2 211 20 discriminator 1
	movl	20(%ebp), %eax
	movl	(%eax), %eax
	.loc 2 211 17 discriminator 1
	cmpl	$1, %eax
	je	L43
	.loc 2 212 16
	movl	$-256, %eax
...
LBE6:
	...
	testl	%eax, %eax
	je	L61
	.loc 2 278 20 discriminator 1
	movl	16(%ebp), %eax
	movl	(%eax), %eax
	.loc 2 278 17 discriminator 1
	cmpl	$1, %eax
	je	L61
	.loc 2 279 16
	movl	$-256, %eax
