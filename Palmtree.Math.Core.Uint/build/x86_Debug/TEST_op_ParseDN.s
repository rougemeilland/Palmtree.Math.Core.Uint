...
LVL5:
	...
	.loc 2 49 85
	movl	-20(%ebp), %edx
	movl	$_actual_buf_size.61616, 12(%esp)
	movl	$256, 8(%esp)
	movl	$_actual_buf.61615, 4(%esp)
	movl	%edx, (%esp)
	call	*%eax
LVL6:
	subl	$16, %esp
	...
	call	_TEST_Assert
	.loc 2 50 75
	movl	_actual_buf_size.61616, %eax
	movl	52(%ebp), %edx
	movl	%edx, 12(%esp)
	movl	48(%ebp), %edx
	movl	%edx, 8(%esp)
	movl	%eax, 4(%esp)
	movl	$_actual_buf.61615, (%esp)
...
LVL13:
	...
	.loc 2 73 85
	movl	-20(%ebp), %edx
	movl	$_actual_buf_size.61632, 12(%esp)
	movl	$256, 8(%esp)
	movl	$_actual_buf.61631, 4(%esp)
	movl	%edx, (%esp)
	call	*%eax
LVL14:
	subl	$16, %esp
	...
	call	_TEST_Assert
	.loc 2 74 75
	movl	_actual_buf_size.61632, %eax
	movl	36(%ebp), %edx
	movl	%edx, 12(%esp)
	movl	32(%ebp), %edx
	movl	%edx, 8(%esp)
	movl	%eax, 4(%esp)
	movl	$_actual_buf.61631, (%esp)
	call	__EQUALS_MEMORY
	.loc 2 74 9
	testl	%eax, %eax
	sete	%al
...
L14:
	...
	.cfi_endproc
LFE73:
.lcomm _actual_buf.61615,256,32
.lcomm _actual_buf_size.61616,4,4
.lcomm _actual_buf.61631,256,32
.lcomm _actual_buf_size.61632,4,4
Letext0:
