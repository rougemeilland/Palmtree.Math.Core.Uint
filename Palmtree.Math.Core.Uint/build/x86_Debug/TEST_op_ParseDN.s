...
LVL5:
	...
	.loc 2 48 85
	movl	-20(%ebp), %edx
	movl	$_actual_buf_size.61435, 12(%esp)
	movl	$256, 8(%esp)
	movl	$_actual_buf.61434, 4(%esp)
	movl	%edx, (%esp)
	call	*%eax
LVL6:
	subl	$16, %esp
	...
	call	_TEST_Assert
	.loc 2 49 75
	movl	_actual_buf_size.61435, %eax
	movl	52(%ebp), %edx
	movl	%edx, 12(%esp)
	movl	48(%ebp), %edx
	movl	%edx, 8(%esp)
	movl	%eax, 4(%esp)
	movl	$_actual_buf.61434, (%esp)
...
LVL9:
	...
	.loc 2 67 85
	movl	-20(%ebp), %edx
	movl	$_actual_buf_size.61451, 12(%esp)
	movl	$256, 8(%esp)
	movl	$_actual_buf.61450, 4(%esp)
	movl	%edx, (%esp)
	call	*%eax
LVL10:
	subl	$16, %esp
	...
	call	_TEST_Assert
	.loc 2 68 75
	movl	_actual_buf_size.61451, %eax
	movl	36(%ebp), %edx
	movl	%edx, 12(%esp)
	movl	32(%ebp), %edx
	movl	%edx, 8(%esp)
	movl	%eax, 4(%esp)
	movl	$_actual_buf.61450, (%esp)
	call	__EQUALS_MEMORY
	.loc 2 68 9
	testl	%eax, %eax
	sete	%al
...
LVL13:
	...
	.loc 2 86 85
	movl	-20(%ebp), %edx
	movl	$_actual_buf_size.61467, 12(%esp)
	movl	$256, 8(%esp)
	movl	$_actual_buf.61466, 4(%esp)
	movl	%edx, (%esp)
	call	*%eax
LVL14:
	subl	$16, %esp
	...
	call	_TEST_Assert
	.loc 2 87 75
	movl	_actual_buf_size.61467, %eax
	movl	36(%ebp), %edx
	movl	%edx, 12(%esp)
	movl	32(%ebp), %edx
	movl	%edx, 8(%esp)
	movl	%eax, 4(%esp)
	movl	$_actual_buf.61466, (%esp)
	call	__EQUALS_MEMORY
	.loc 2 87 9
	testl	%eax, %eax
	sete	%al
...
L18:
	...
	.cfi_endproc
LFE74:
.lcomm _actual_buf.61434,256,32
.lcomm _actual_buf_size.61435,4,4
.lcomm _actual_buf.61450,256,32
.lcomm _actual_buf_size.61451,4,4
.lcomm _actual_buf.61466,256,32
.lcomm _actual_buf_size.61467,4,4
Letext0:
