...
LVL5:
	...
	.loc 2 48 85
	movl	-20(%ebp), %edx
	movl	$_actual_buf_size.61469, 12(%esp)
	movl	$256, 8(%esp)
	movl	$_actual_buf.61468, 4(%esp)
	movl	%edx, (%esp)
	call	*%eax
LVL6:
	subl	$16, %esp
	...
	call	_TEST_Assert
	.loc 2 49 75
	movl	_actual_buf_size.61469, %eax
	movl	52(%ebp), %edx
	movl	%edx, 12(%esp)
	movl	48(%ebp), %edx
	movl	%edx, 8(%esp)
	movl	%eax, 4(%esp)
	movl	$_actual_buf.61468, (%esp)
...
LVL9:
	...
	.loc 2 67 85
	movl	-20(%ebp), %edx
	movl	$_actual_buf_size.61485, 12(%esp)
	movl	$256, 8(%esp)
	movl	$_actual_buf.61484, 4(%esp)
	movl	%edx, (%esp)
	call	*%eax
LVL10:
	subl	$16, %esp
	...
	call	_TEST_Assert
	.loc 2 68 75
	movl	_actual_buf_size.61485, %eax
	movl	36(%ebp), %edx
	movl	%edx, 12(%esp)
	movl	32(%ebp), %edx
	movl	%edx, 8(%esp)
	movl	%eax, 4(%esp)
	movl	$_actual_buf.61484, (%esp)
	call	__EQUALS_MEMORY
	.loc 2 68 9
	testl	%eax, %eax
	sete	%al
...
LC5:
	...
	.text
	.globl	_TEST_PMC_ParseDN3
	.def	_TEST_PMC_ParseDN3;	.scl	2;	.type	32;	.endef
_TEST_PMC_ParseDN3:
LFB74:
	.loc 2 75 1
	.cfi_startproc
...
LVL13:
	...
	.loc 2 86 85
	movl	-20(%ebp), %edx
	movl	$_actual_buf_size.61501, 12(%esp)
	movl	$256, 8(%esp)
	movl	$_actual_buf.61500, 4(%esp)
	movl	%edx, (%esp)
	call	*%eax
LVL14:
	subl	$16, %esp
	...
	call	_TEST_Assert
	.loc 2 87 75
	movl	_actual_buf_size.61501, %eax
	movl	36(%ebp), %edx
	movl	%edx, 12(%esp)
	movl	32(%ebp), %edx
	movl	%edx, 8(%esp)
	movl	%eax, 4(%esp)
	movl	$_actual_buf.61500, (%esp)
	call	__EQUALS_MEMORY
	.loc 2 87 9
	testl	%eax, %eax
	sete	%al
...
L18:
	...
	.cfi_endproc
LFE74:
.lcomm _actual_buf.61468,256,32
.lcomm _actual_buf_size.61469,4,4
.lcomm _actual_buf.61484,256,32
.lcomm _actual_buf_size.61485,4,4
.lcomm _actual_buf.61500,256,32
.lcomm _actual_buf_size.61501,4,4
Letext0:
	...
	.file 30 "../pmc.h"
	.file 31 "../pmc_uint.h"
	.file 32 "C:/GNU/MINGW64/i686-8.1.0-win32-dwarf-rt_v6-rev0/mingw32/i686-w64-mingw32/include/winbase.h"
