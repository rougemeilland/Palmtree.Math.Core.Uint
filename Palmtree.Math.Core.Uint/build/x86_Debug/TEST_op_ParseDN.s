...
LVL13:
	...
	.loc 2 73 85
	movl	-20(%ebp), %edx
	movl	$_actual_buf_size.61648, 12(%esp)
	movl	$256, 8(%esp)
	movl	$_actual_buf.61647, 4(%esp)
	movl	%edx, (%esp)
	call	*%eax
LVL14:
	subl	$16, %esp
	...
	call	_TEST_Assert
	.loc 2 74 75
	movl	_actual_buf_size.61648, %eax
	movl	36(%ebp), %edx
	movl	%edx, 12(%esp)
	movl	32(%ebp), %edx
	movl	%edx, 8(%esp)
	movl	%eax, 4(%esp)
	movl	$_actual_buf.61647, (%esp)
	call	__EQUALS_MEMORY
	.loc 2 74 9
	testl	%eax, %eax
	sete	%al
...
.lcomm _actual_buf.61647,256,32
.lcomm _actual_buf_size.61648,4,4
Letext0:
