...
LC3:
	...
	.text
	.globl	_TEST_PMC_ToStringE
	.def	_TEST_PMC_ToStringE;	.scl	2;	.type	32;	.endef
_TEST_PMC_ToStringE:
LFB72:
...
LVL2:
	...
	movl	-20(%ebp), %edx
	movl	$8192, 16(%esp)
	movl	$_actual_str_buffer.61463, 12(%esp)
	leal	-196(%ebp), %ecx
	movl	%ecx, 8(%esp)
	movl	28(%ebp), %ecx
	movl	%ecx, 4(%esp)
...
LVL3:
	...
	movl	36(%ebp), %eax
	movl	%eax, 4(%esp)
	movl	$_actual_str_buffer.61463, (%esp)
...
L3:
	...
	.cfi_endproc
LFE72:
.lcomm _actual_str_buffer.61463,8192,32
Letext0:
