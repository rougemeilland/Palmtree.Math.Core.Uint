...
../../dist/Release/x86/Palmtree.Math.Core.Uint.dll: $(OBJS) ../Palmtree.Math.Core.Uint.def
	...
	gcc -o ../../dist/Release/x86/Palmtree.Math.Core.Uint.dll $(OBJS) ../Palmtree.Math.Core.Uint.def -shared -lkernel32 -luser32 -mwindows -nostdlib -Wl,--enable-stdcall-fixup -Wl,-e_DllMain@12 -Wl,-Map=../build/x86_Release/Palmtree.Math.Core.Uint.map 
