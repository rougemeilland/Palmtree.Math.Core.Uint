...
; 164  :     return (&entry_points);
	...
	mov	DWORD PTR _entry_points+40, OFFSET _PMC_To_X_I@8
	mov	DWORD PTR _entry_points+44, OFFSET _PMC_To_X_L@8
	...
	mov	DWORD PTR _entry_points+36, OFFSET _PMC_Clone_X@8
