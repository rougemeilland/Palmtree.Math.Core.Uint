...
;	COMDAT pdata
pdata	SEGMENT
$pdata$0$PMC_BitwiseAnd_X_X DD imagerel $LN23+76
	DD	imagerel $LN23+221
	DD	imagerel $chain$0$PMC_BitwiseAnd_X_X
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
$pdata$1$PMC_BitwiseAnd_X_X DD imagerel $LN23+221
