...
; 564  :     lstrcpyW(info->NativeDigits, L"0123456789");
	...
	lea	rcx, QWORD PTR [rbx+146]
	lea	rdx, OFFSET FLAT:??_C@_1BG@PGBNDIAE@?$AA0?$AA1?$AA2?$AA3?$AA4?$AA5?$AA6?$AA7?$AA8?$AA9@
	call	QWORD PTR __imp_lstrcpyW
