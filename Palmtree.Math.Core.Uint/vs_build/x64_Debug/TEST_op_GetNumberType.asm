...
msvcjmc	ENDS
PUBLIC	TEST_PMC_GetNumberType_X
PUBLIC	__JustMyCode_Default
PUBLIC	??_C@_1EK@HDEICNAJ@?$AAP?$AAM?$AAC?$AA_?$AAF?$AAr?$AAo?$AAm?$AAB?$AAy?$AAt?$AAe?$AAA?$AAr?$AAr@ ; `string'
PUBLIC	??_C@_1EC@HAKJMGDA@?$AAT?$AAE?$AAS?$AAT?$AA_?$AAP?$AAM?$AAC?$AA_?$AAG?$AAe?$AAt?$AAN?$AAu?$AAm@ ; `string'
...
;	COMDAT pdata
pdata	SEGMENT
$pdata$TEST_PMC_GetNumberType_X DD imagerel $LN10
	DD	imagerel $LN10+465
	DD	imagerel $unwind$TEST_PMC_GetNumberType_X
pdata	ENDS
;	COMDAT rtc$TMZ
rtc$TMZ	SEGMENT
...
CONST	ENDS
;	COMDAT ??_C@_1EC@HAKJMGDA@?$AAT?$AAE?$AAS?$AAT?$AA_?$AAP?$AAM?$AAC?$AA_?$AAG?$AAe?$AAt?$AAN?$AAu?$AAm@
CONST	SEGMENT
??_C@_1EC@HAKJMGDA@?$AAT?$AAE?$AAS?$AAT?$AA_?$AAP?$AAM?$AAC?$AA_?$AAG?$AAe?$AAt?$AAN?$AAu?$AAm@ DB 'T'
	DB	00H, 'E', 00H, 'S', 00H, 'T', 00H, '_', 00H, 'P', 00H, 'M', 00H
	DB	'C', 00H, '_', 00H, 'G', 00H, 'e', 00H, 't', 00H, 'N', 00H, 'u'
	DB	00H, 'm', 00H, 'b', 00H, 'e', 00H, 'r', 00H, 'T', 00H, 'y', 00H
	DB	'p', 00H, 'e', 00H, '_', 00H, 'X', 00H, ' ', 00H, '(', 00H, '%'
...
;	COMDAT xdata
xdata	SEGMENT
$unwind$TEST_PMC_GetNumberType_X DD 025053901H
	DD	011d2322H
	DD	07016002dH
	DD	05015H
xdata	ENDS
;	COMDAT CONST
CONST	SEGMENT
TEST_PMC_GetNumberType_X$rtcName$0 DB 078H
	DB	00H
	ORG $+6
TEST_PMC_GetNumberType_X$rtcName$1 DB 061H
	DB	063H
	DB	074H
	DB	075H
	DB	061H
	...
	DB	00H
	ORG $+11
TEST_PMC_GetNumberType_X$rtcVarDesc DD 044H
	DD	04H
	DQ	FLAT:TEST_PMC_GetNumberType_X$rtcName$1
	DD	028H
	DD	08H
	DQ	FLAT:TEST_PMC_GetNumberType_X$rtcName$0
	ORG $+96
TEST_PMC_GetNumberType_X$rtcFrameData DD 02H
	DD	00H
	DQ	FLAT:TEST_PMC_GetNumberType_X$rtcVarDesc
CONST	ENDS
...
;	COMDAT TEST_PMC_GetNumberType_X
_TEXT	SEGMENT
x$ = 8
actual_value$ = 36
result$ = 68
...
x_buf_size$ = 384
desired_value$ = 392
TEST_PMC_GetNumberType_X PROC				; COMDAT
...
$LN10:
	...
	lea	rcx, OFFSET FLAT:__2E587E3B_test_op_getnumbertype@c
...
$LN5@TEST_PMC_G:
	...
	lea	rcx, OFFSET FLAT:??_C@_1EC@HAKJMGDA@?$AAT?$AAE?$AAS?$AAT?$AA_?$AAP?$AAM?$AAC?$AA_?$AAG?$AAe?$AAt?$AAN?$AAu?$AAm@
...
; 43   : }
	...
	lea	rdx, OFFSET FLAT:TEST_PMC_GetNumberType_X$rtcFrameData
	call	_RTC_CheckStackVars
	lea	rsp, QWORD PTR [rbp+328]
	pop	rdi
	pop	rbp
	ret	0
TEST_PMC_GetNumberType_X ENDP
_TEXT	ENDS
END
