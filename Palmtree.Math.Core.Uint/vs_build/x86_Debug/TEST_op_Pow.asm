...
$SG94747 DB	'P', 00H, 'M', 00H, 'C', 00H, '_', 00H, 'F', 00H, 'r', 00H
	...
	ORG $+2
$SG94748 DB	'P', 00H, 'M', 00H, 'C', 00H, '_', 00H, 'P', 00H, 'o', 00H
	DB	'w', 00H, '_', 00H, 'X', 00H, '_', 00H, 'I', 00H, ' ', 00H, '('
	DB	00H, '%', 00H, 'd', 00H, '.', 00H, '%', 00H, 'd', 00H, ')', 00H
	DB	00H, 00H
$SG94749 DB	'P', 00H, 'M', 00H, 'C', 00H, '_', 00H, 'P', 00H, 'o', 00H
	...
	DB	00H
	ORG $+2
$SG94750 DB	'P', 00H, 'M', 00H, 'C', 00H, '_', 00H, 'P', 00H, 'o', 00H
	DB	'w', 00H, '_', 00H, 'X', 00H, '_', 00H, 'I', 00H, ' ', 00H, '('
	DB	00H, '%', 00H, 'd', 00H, '.', 00H, '%', 00H, 'd', 00H, ')', 00H
	DB	00H, 00H
	ORG $+4
$SG94752 DB	'P', 00H, 'M', 00H, 'C', 00H, '_', 00H, 'T', 00H, 'o', 00H
	...
	ORG $+2
$SG94753 DB	'P', 00H, 'M', 00H, 'C', 00H, '_', 00H, 'P', 00H, 'o', 00H
	DB	'w', 00H, '_', 00H, 'X', 00H, '_', 00H, 'I', 00H, ' ', 00H, '('
	DB	00H, '%', 00H, 'd', 00H, '.', 00H, '%', 00H, 'd', 00H, ')', 00H
	DB	00H, 00H
$SG94754 DB	0c7H, '0', 0fcH, '0', 0bfH, '0n0', 085H, 'Q', 0b9H, '[L0', 00H
	DB	'N', 0f4H, 081H, 'W0j0D0', 00H, 00H
	ORG $+2
$SG94755 DB	'P', 00H, 'M', 00H, 'C', 00H, '_', 00H, 'P', 00H, 'o', 00H
	DB	'w', 00H, '_', 00H, 'X', 00H, '_', 00H, 'I', 00H, ' ', 00H, '('
	DB	00H, '%', 00H, 'd', 00H, '.', 00H, '%', 00H, 'd', 00H, ')', 00H
	DB	00H, 00H
_DATA	ENDS
