...
rtc$IMZ	ENDS
_DATA	SEGMENT
$SG94979 DB	'P', 00H, 'M', 00H, 'C', 00H, '_', 00H, 'F', 00H, 'r', 00H
	...
	ORG $+6
$SG94980 DB	'T', 00H, 'E', 00H, 'S', 00H, 'T', 00H, '_', 00H, 'P', 00H
...
$SG94981 DB	'P', 00H, 'M', 00H, 'C', 00H, '_', 00H, 'G', 00H, 'e', 00H
	...
	DB	00H
$SG94982 DB	'T', 00H, 'E', 00H, 'S', 00H, 'T', 00H, '_', 00H, 'P', 00H
	DB	'M', 00H, 'C', 00H, '_', 00H, 'G', 00H, 'e', 00H, 't', 00H, 'N'
	DB	00H, 'u', 00H, 'm', 00H, 'b', 00H, 'e', 00H, 'r', 00H, 'T', 00H
	DB	'y', 00H, 'p', 00H, 'e', 00H, '_', 00H, 'X', 00H, ' ', 00H, '('
	DB	00H, '%', 00H, 'd', 00H, '.', 00H, '%', 00H, 'd', 00H, ')', 00H
	DB	00H, 00H
	ORG $+2
$SG94983 DB	0c7H, '0', 0fcH, '0', 0bfH, '0n0', 085H, 'Q', 0b9H, '[L0', 00H
	DB	'N', 0f4H, 081H, 'W0j0D0', 00H, 00H
	ORG $+2
$SG94984 DB	'T', 00H, 'E', 00H, 'S', 00H, 'T', 00H, '_', 00H, 'P', 00H
	DB	'M', 00H, 'C', 00H, '_', 00H, 'G', 00H, 'e', 00H, 't', 00H, 'N'
	DB	00H, 'u', 00H, 'm', 00H, 'b', 00H, 'e', 00H, 'r', 00H, 'T', 00H
	DB	'y', 00H, 'p', 00H, 'e', 00H, '_', 00H, 'X', 00H, ' ', 00H, '('
	DB	00H, '%', 00H, 'd', 00H, '.', 00H, '%', 00H, 'd', 00H, ')', 00H
