...
$SG95023 DB	'P', 00H, 'M', 00H, 'C', 00H, '_', 00H, 'F', 00H, 'r', 00H
	...
	ORG $+2
$SG95024 DB	'P', 00H, 'M', 00H, 'C', 00H, '_', 00H, 'C', 00H, 'l', 00H
	DB	'o', 00H, 'n', 00H, 'e', 00H, '_', 00H, 'X', 00H, ' ', 00H, '('
	DB	00H, '%', 00H, 'd', 00H, '.', 00H, '%', 00H, 'd', 00H, ')', 00H
	DB	00H, 00H
$SG95025 DB	'P', 00H, 'M', 00H, 'C', 00H, '_', 00H, 'C', 00H, 'l', 00H
	...
	DB	00H
	ORG $+2
$SG95026 DB	'P', 00H, 'M', 00H, 'C', 00H, '_', 00H, 'C', 00H, 'l', 00H
	DB	'o', 00H, 'n', 00H, 'e', 00H, '_', 00H, 'X', 00H, ' ', 00H, '('
	DB	00H, '%', 00H, 'd', 00H, '.', 00H, '%', 00H, 'd', 00H, ')', 00H
	DB	00H, 00H
	ORG $+4
$SG95027 DB	'P', 00H, 'M', 00H, 'C', 00H, '_', 00H, 'T', 00H, 'o', 00H
	...
	ORG $+2
$SG95028 DB	'P', 00H, 'M', 00H, 'C', 00H, '_', 00H, 'C', 00H, 'l', 00H
	DB	'o', 00H, 'n', 00H, 'e', 00H, '_', 00H, 'X', 00H, ' ', 00H, '('
	DB	00H, '%', 00H, 'd', 00H, '.', 00H, '%', 00H, 'd', 00H, ')', 00H
	DB	00H, 00H
$SG95029 DB	0c7H, '0', 0fcH, '0', 0bfH, '0n0', 085H, 'Q', 0b9H, '[L0', 00H
	...
	ORG $+2
$SG95030 DB	'P', 00H, 'M', 00H, 'C', 00H, '_', 00H, 'C', 00H, 'l', 00H
	DB	'o', 00H, 'n', 00H, 'e', 00H, '_', 00H, 'X', 00H, ' ', 00H, '('
	DB	00H, '%', 00H, 'd', 00H, '.', 00H, '%', 00H, 'd', 00H, ')', 00H
	DB	00H, 00H
_DATA	ENDS
