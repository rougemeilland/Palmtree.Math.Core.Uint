...
; 121  :         entry_points.To_X_I = PMC_To_X_I;
	...
	mov	DWORD PTR _entry_points+44, OFFSET _PMC_To_X_I@8

; 122  :         entry_points.To_X_L = PMC_To_X_L;

	mov	DWORD PTR _entry_points+48, OFFSET _PMC_To_X_L@8
...
; 124  :         entry_points.FromByteArrayForSINT = PMC_FromByteArrayForSINT;
	...
	mov	DWORD PTR _entry_points+32, OFFSET _PMC_FromByteArrayForSINT@16
...
; 126  :         entry_points.ToByteArrayForSINT = PMC_ToByteArrayForSINT;
	...
	mov	DWORD PTR _entry_points+36, OFFSET _PMC_ToByteArrayForSINT@20

; 127  :         entry_points.ToString = PMC_ToString;

	mov	DWORD PTR _entry_points+52, OFFSET _PMC_ToString@24

; 128  :         entry_points.TryParse = PMC_TryParse;

	mov	DWORD PTR _entry_points+56, OFFSET _PMC_TryParse@16

; 129  :         entry_points.Add_I_X = PMC_Add_I_X;

	mov	DWORD PTR _entry_points+60, OFFSET _PMC_Add_I_X@12

; 130  :         entry_points.Add_L_X = PMC_Add_L_X;

	mov	DWORD PTR _entry_points+64, OFFSET _PMC_Add_L_X@16

; 131  :         entry_points.Add_X_I = PMC_Add_X_I;

	mov	DWORD PTR _entry_points+68, OFFSET _PMC_Add_X_I@12

; 132  :         entry_points.Add_X_L = PMC_Add_X_L;

	mov	DWORD PTR _entry_points+72, OFFSET _PMC_Add_X_L@16

; 133  :         entry_points.Add_X_X = PMC_Add_X_X;

	mov	DWORD PTR _entry_points+76, OFFSET _PMC_Add_X_X@12

; 134  :         entry_points.Subtruct_I_X = PMC_Subtruct_I_X;

	mov	DWORD PTR _entry_points+80, OFFSET _PMC_Subtruct_I_X@12

; 135  :         entry_points.Subtruct_L_X = PMC_Subtruct_L_X;

	mov	DWORD PTR _entry_points+84, OFFSET _PMC_Subtruct_L_X@16

; 136  :         entry_points.Subtruct_X_I = PMC_Subtruct_X_I;

	mov	DWORD PTR _entry_points+88, OFFSET _PMC_Subtruct_X_I@12

; 137  :         entry_points.Subtruct_X_L = PMC_Subtruct_X_L;

	mov	DWORD PTR _entry_points+92, OFFSET _PMC_Subtruct_X_L@16

; 138  :         entry_points.Subtruct_X_X = PMC_Subtruct_X_X;

	mov	DWORD PTR _entry_points+96, OFFSET _PMC_Subtruct_X_X@12

; 139  :         entry_points.Multiply_I_X = PMC_Multiply_I_X;

	mov	DWORD PTR _entry_points+100, OFFSET _PMC_Multiply_I_X@12

; 140  :         entry_points.Multiply_L_X = PMC_Multiply_L_X;

	mov	DWORD PTR _entry_points+104, OFFSET _PMC_Multiply_L_X@16

; 141  :         entry_points.Multiply_X_I = PMC_Multiply_X_I;

	mov	DWORD PTR _entry_points+108, OFFSET _PMC_Multiply_X_I@12

; 142  :         entry_points.Multiply_X_L = PMC_Multiply_X_L;

	mov	DWORD PTR _entry_points+112, OFFSET _PMC_Multiply_X_L@16

; 143  :         entry_points.Multiply_X_X = PMC_Multiply_X_X;

	mov	DWORD PTR _entry_points+116, OFFSET _PMC_Multiply_X_X@12

; 144  :         entry_points.DivRem_I_X = PMC_DivRem_I_X;

	mov	DWORD PTR _entry_points+120, OFFSET _PMC_DivRem_I_X@16

; 145  :         entry_points.DivRem_L_X = PMC_DivRem_L_X;

	mov	DWORD PTR _entry_points+124, OFFSET _PMC_DivRem_L_X@20

; 146  :         entry_points.DivRem_X_I = PMC_DivRem_X_I;

	mov	DWORD PTR _entry_points+128, OFFSET _PMC_DivRem_X_I@16

; 147  :         entry_points.DivRem_X_L = PMC_DivRem_X_L;

	mov	DWORD PTR _entry_points+132, OFFSET _PMC_DivRem_X_L@20

; 148  :         entry_points.DivRem_X_X = PMC_DivRem_X_X;

	mov	DWORD PTR _entry_points+136, OFFSET _PMC_DivRem_X_X@16

; 149  :         entry_points.RightShift_X_I = PMC_RightShift_X_I;

	mov	DWORD PTR _entry_points+144, OFFSET _PMC_RightShift_X_I@12

; 150  :         entry_points.LeftShift_X_I = PMC_LeftShift_X_I;

	mov	DWORD PTR _entry_points+140, OFFSET _PMC_LeftShift_X_I@12
...
; 184  :         entry_points.Clone_X = PMC_Clone_X;
	...
	mov	DWORD PTR _entry_points+40, OFFSET _PMC_Clone_X@8
