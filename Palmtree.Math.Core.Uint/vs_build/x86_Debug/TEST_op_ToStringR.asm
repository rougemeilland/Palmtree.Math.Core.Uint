; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27026.1 
	...
	TITLE	Z:\Sources\Lunor\Repos\rougemeilland\Palmtree.Math.Core.Uint\Palmtree.Math.Core.Uint\TEST_op_ToStringR.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
$SG94740 DB	'T', 00H, 'o', 00H, 'S', 00H, 't', 00H, 'r', 00H, 'i', 00H
	DB	'n', 00H, 'g', 00H, 'R', 00H, ' ', 00H, '(', 00H, '%', 00H, 'd'
...
; 33   : {
	...
	mov	ecx, OFFSET __B5EE0323_test_op_tostringr@c
...
; 42   :     TEST_Assert(env, FormatTestLabel(L"ToStringR (%d.%d)", no, 2), (result = ep->ToString(x, format, &opt, actual_str_buffer, sizeof(actual_str_buffer))) == PMC_STATUS_OK, FormatTestMesssage(L"PMC_ToStringの復帰コードが期待通りではない(%d)", result));
	...
	mov	esi, esp
	push	8192					; 00002000H
	push	OFFSET ?actual_str_buffer@?1??TEST_PMC_ToStringR@@9@9
	lea	eax, DWORD PTR _opt$[ebp]
	push	eax
