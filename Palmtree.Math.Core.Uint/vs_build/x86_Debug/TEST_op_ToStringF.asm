; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27026.1 
	...
	TITLE	Z:\Sources\Lunor\Repos\rougemeilland\Palmtree.Math.Core.Uint\Palmtree.Math.Core.Uint\TEST_op_ToStringF.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
$SG94744 DB	'P', 00H, 'M', 00H, 'C', 00H, '_', 00H, 'T', 00H, 'o', 00H
	DB	'S', 00H, 't', 00H, 'r', 00H, 'i', 00H, 'n', 00H, 'g', 00H, 'F'
	DB	00H, ' ', 00H, '(', 00H, '%', 00H, 'd', 00H, '.', 00H, '%', 00H
	DB	'd', 00H, ')', 00H, 00H, 00H
$SG94745 DB	'P', 00H, 'M', 00H, 'C', 00H, '_', 00H, 'T', 00H, 'o', 00H
...
$SG94746 DB	'P', 00H, 'M', 00H, 'C', 00H, '_', 00H, 'T', 00H, 'o', 00H
	...
	DB	00H, ' ', 00H, '(', 00H, '%', 00H, 'd', 00H, '.', 00H, '%', 00H
	DB	'd', 00H, ')', 00H, 00H, 00H
$SG94747 DB	0c7H, '0', 0fcH, '0', 0bfH, '0n0', 085H, 'Q', 0b9H, '[L0', 00H
...
_decimal_digits$ = 36					; size = 4
_desired_str$ = 40					; size = 4
_TEST_PMC_ToStringF PROC
...
; 33   : {
	...
	mov	ecx, OFFSET __AEC1088F_test_op_tostringf@c
...
; 43   :     TEST_Assert(env, FormatTestLabel(L"PMC_ToStringF (%d.%d)", no, 2), (result = ep->ToString(x, format, &opt, actual_str_buffer, sizeof(actual_str_buffer))) == PMC_STATUS_OK, FormatTestMesssage(L"PMC_ToStringの復帰コードが期待通りではない(%d)", result));
	...
	mov	esi, esp
	push	8192					; 00002000H
	push	OFFSET ?actual_str_buffer@?1??TEST_PMC_ToStringF@@9@9
	lea	eax, DWORD PTR _opt$[ebp]
	push	eax
