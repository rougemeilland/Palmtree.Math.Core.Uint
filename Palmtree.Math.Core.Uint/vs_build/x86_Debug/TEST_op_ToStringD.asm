; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27026.1 
	...
	TITLE	Z:\Sources\Lunor\Repos\rougemeilland\Palmtree.Math.Core.Uint\Palmtree.Math.Core.Uint\TEST_op_ToStringD.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
__AD45DCE1_test_op_tostringd@c DB 01H
msvcjmc	ENDS
...
rtc$IMZ	ENDS
_DATA	SEGMENT
$SG94982 DB	',', 00H, 00H, 00H
$SG94983 DB	'3', 00H
	ORG $+2
$SG94984 DB	'.', 00H, 00H, 00H
$SG94985 DB	'+', 00H, 00H, 00H
$SG94986 DB	'-', 00H, 00H, 00H
$SG94988 DB	'T', 00H, 'o', 00H, 'S', 00H, 't', 00H, 'r', 00H, 'i', 00H
...
$SG94987 DB	'P', 00H, 'M', 00H, 'C', 00H, '_', 00H, 'F', 00H, 'r', 00H
	...
	ORG $+2
$SG94990 DB	'T', 00H, 'o', 00H, 'S', 00H, 't', 00H, 'r', 00H, 'i', 00H
	DB	'n', 00H, 'g', 00H, 'D', 00H, ' ', 00H, '(', 00H, '%', 00H, 'd'
	DB	00H, '.', 00H, '%', 00H, 'd', 00H, ')', 00H, 00H, 00H
$SG94989 DB	'P', 00H, 'M', 00H, 'C', 00H, '_', 00H, 'T', 00H, 'o', 00H
	...
	DB	00H, 00H, 00H
$SG94991 DB	0c7H, '0', 0fcH, '0', 0bfH, '0n0', 085H, 'Q', 0b9H, '[L0', 00H
	DB	'N', 0f4H, 081H, 'W0j0D0', 00H, 00H
	ORG $+2
$SG94992 DB	'T', 00H, 'o', 00H, 'S', 00H, 't', 00H, 'r', 00H, 'i', 00H
	DB	'n', 00H, 'g', 00H, 'D', 00H, ' ', 00H, '(', 00H, '%', 00H, 'd'
	DB	00H, '.', 00H, '%', 00H, 'd', 00H, ')', 00H, 00H, 00H
_DATA	ENDS
...
; File z:\sources\lunor\repos\rougemeilland\palmtree.math.core.uint\palmtree.math.core.uint\test_op_tostringd.c
_TEXT	SEGMENT
tv150 = -84						; size = 4
tv137 = -80						; size = 4
tv84 = -76						; size = 4
...
; 33   : {
	...
	mov	ecx, OFFSET __AD45DCE1_test_op_tostringd@c
...
; 45   :     TEST_Assert(env, FormatTestLabel(L"ToStringD (%d.%d)", no, 1), (x_result = ep->PMC_FromByteArray(buf, buf_size, &x)) == PMC_STATUS_OK, FormatTestMesssage(L"PMC_FromByteArrayの復帰コードが期待通りではない(%d)", x_result));
...
; 46   :     TEST_Assert(env, FormatTestLabel(L"ToStringD (%d.%d)", no, 2), (result = ep->PMC_ToString(x, actual_str_buffer, sizeof(actual_str_buffer), format_spec, min_width, &opt)) == PMC_STATUS_OK, FormatTestMesssage(L"PMC_ToStringの復帰コードが期待通りではない(%d)", result));
...
; 47   :     TEST_Assert(env, FormatTestLabel(L"ToStringD (%d.%d)", no, 3), lstrcmpW(actual_str_buffer, desired_str) == 0, L"データの内容が一致しない");
