; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27026.1 
	...
	TITLE	Z:\Sources\Lunor\Repos\rougemeilland\Palmtree.Math.Core.Uint\Palmtree.Math.Core.Uint\TEST_op_ToStringG.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
$SG94739 DB	'P', 00H, 'M', 00H, 'C', 00H, '_', 00H, 'F', 00H, 'r', 00H
	...
	ORG $+2
$SG94740 DB	'T', 00H, 'o', 00H, 'S', 00H, 't', 00H, 'r', 00H, 'i', 00H
	DB	'n', 00H, 'g', 00H, 'G', 00H, ' ', 00H, '(', 00H, '%', 00H, 'd'
...
$SG94741 DB	'P', 00H, 'M', 00H, 'C', 00H, '_', 00H, 'T', 00H, 'o', 00H
	...
	DB	00H, 00H, 00H
$SG94742 DB	'T', 00H, 'o', 00H, 'S', 00H, 't', 00H, 'r', 00H, 'i', 00H
	DB	'n', 00H, 'g', 00H, 'G', 00H, ' ', 00H, '(', 00H, '%', 00H, 'd'
	DB	00H, '.', 00H, '%', 00H, 'd', 00H, ')', 00H, 00H, 00H
$SG94743 DB	0c7H, '0', 0fcH, '0', 0bfH, '0n0', 085H, 'Q', 0b9H, '[L0', 00H
	DB	'N', 0f4H, 081H, 'W0j0D0', 00H, 00H
	ORG $+2
$SG94744 DB	'T', 00H, 'o', 00H, 'S', 00H, 't', 00H, 'r', 00H, 'i', 00H
	DB	'n', 00H, 'g', 00H, 'G', 00H, ' ', 00H, '(', 00H, '%', 00H, 'd'
	DB	00H, '.', 00H, '%', 00H, 'd', 00H, ')', 00H, 00H, 00H
_DATA	ENDS
...
_x_value$ = 20						; size = 8
_format$ = 28						; size = 4
_desired_str$ = 32					; size = 4
_TEST_PMC_ToStringG PROC
...
; 33   : {
	...
	mov	ecx, OFFSET __AF0362B8_test_op_tostringg@c
...
; 41   :     TEST_Assert(env, FormatTestLabel(L"ToStringG (%d.%d)", no, 1), (x_result = ep->From_L(x_value, &x)) == PMC_STATUS_OK, FormatTestMesssage(L"PMC_FromByteArrayの復帰コードが期待通りではない(%d)", x_result));
	...
	push	eax
	mov	ecx, DWORD PTR _x_value$[ebp+4]
	push	ecx
	mov	edx, DWORD PTR _x_value$[ebp]
	push	edx
...
; 42   :     TEST_Assert(env, FormatTestLabel(L"ToStringG (%d.%d)", no, 2), (result = ep->ToString(x, format, &opt, actual_str_buffer, sizeof(actual_str_buffer))) == PMC_STATUS_OK, FormatTestMesssage(L"PMC_ToStringの復帰コードが期待通りではない(%d)", result));
	...
	mov	esi, esp
	push	8192					; 00002000H
	push	OFFSET ?actual_str_buffer@?1??TEST_PMC_ToStringG@@9@9
	lea	eax, DWORD PTR _opt$[ebp]
	push	eax
