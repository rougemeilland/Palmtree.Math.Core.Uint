        ...
        protected override IEnumerable<TestTerm> CreateTestTerms(IEnumerable<InputTestData> in_source)
        {
            var source = in_source
                ...
                .Select(item => new
                {
                    ...
                    desired_w = new OutputTestData(_id, new[] { item.u, item.v }, item.u.BigIntegerValue >= item.v.BigIntegerValue, item.u.BigIntegerValue >= item.v.BigIntegerValue, item.u.BigIntegerValue >= item.v.BigIntegerValue ? item.u.BigIntegerValue - item.v.BigIntegerValue : BigInteger.Zero),
                });
            return (source
